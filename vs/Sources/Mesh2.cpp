...
Mesh2::Mesh2(Vertex2* vertices, unsigned int numVertices, unsigned int* indices, unsigned int numIndices, bool generateNormal)
{
...
glm::vec3 Mesh2::calcNormal(const glm::vec3& p1, const glm::vec3& p2, const glm::vec3& p3)
{
	glm::vec3 U = (p2 - p1);
	glm::vec3 V = (p3 - p1);
